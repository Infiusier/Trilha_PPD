...
"border-radius: 30px;")
        ...
        self.color_label.setGeometry(QRect(230, 660, 141, 31))
        font5 = QFont()
        font5.setFamily(u"Cubic")
        font5.setPointSize(20)
        self.color_label.setFont(font5)
        self.color_label.setStyleSheet(u"color: rgb(170, 0, 0);")
        self.ip_input = QLineEdit(self.frame)
        self.ip_input.setObjectName(u"ip_input")
        self.ip_input.setGeometry(QRect(920, 150, 261, 41))
        font6 = QFont()
        font6.setFamily(u"MS Shell Dlg 2")
        font6.setPointSize(10)
        self.ip_input.setFont(font6)
        self.port_input = QSpinBox(self.frame)
        self.port_input.setObjectName(u"port_input")
        self.port_input.setGeometry(QRect(920, 200, 261, 41))
        font7 = QFont()
        font7.setPointSize(10)
        self.port_input.setFont(font7)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.color_label.setText(QCoreApplication.translate("MainWindow", u"Sua Cor", None))
    # retranslateUi
